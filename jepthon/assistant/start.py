    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/Z_X_Z_B"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنصيب سورس افاتار", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/Z_X_Z_B")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/Help_Tele_Av)],
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("@انت لا تستطيع استخدام البوت احصل على بوتك من @Z_X_Z_Balert=True)




@tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"rozname"))) 
async def settings(event):  #قسم الزغرفه افاتار
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(event.chat_id,
...
async def settings(event):  #    قـسـم  الزغرفـة لأسـماء الشـباب
    if event.sender_id == bot.uid:
        ...
        await event.answer("@Z_X_Z_Bتطيع استخدام البوت احصل على بوتك من @Z_X_Z_Balert=True)
...
async def settings(event):  #    قـسـم  البـايو 1
    if event.sender_id == bot.uid:
        ...
        await event.answer(@Z_X_Z_Bستطيع استخدام البوت احصل على بوتك من @Z_X_Z_Balert=True)
